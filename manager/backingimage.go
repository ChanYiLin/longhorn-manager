...
func (m *VolumeManager) CreateBackingImage(name, checksum, sourceType string, parameters map[string]string, secret, secretNamespace string) (bi *longhorn.BackingImage, err error) {
